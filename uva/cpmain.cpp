// https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=166
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
  ...
  while (scanf("%s ", book))
  { // Using 'book' as buffer to read the command
    string cmd(book);
    if (cmd == "END")
      break;
    if (cmd == "SHELVE")
